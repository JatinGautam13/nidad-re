      ...
      <div className={styles.container}>
        ...
        <div className={styles.column}>
          ...
          <ul className={styles.list}>
            <li><a href="#" className={styles.link}>For Individuals</a></li>
            <li><a href="#" className={styles.link}>Compression</a></li>
            ...
            <li><a href="#" className={styles.link}>Policy</a></li>
          </ul>
        </div>
        ...
        <div className={styles.column}>
          ...
          <ul className={styles.list}>
            ...
            <li><a href="#" className={styles.link}>Usages</a></li>
            <li><a href="#" className={styles.link}>Elements</a></li>
            <li><a href="#" className={styles.link}>Global</a></li>
          </ul>
        </div>
        ...
        <div className={styles.column}>
          ...
          <ul className={styles.list}>
            ...
            <li><a href="#" className={styles.link}>Visibility</a></li>
