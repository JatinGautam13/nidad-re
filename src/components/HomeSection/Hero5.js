...
const stats = [
	{
		...
		value: "96%",
		note: "Students placed within 6 months",
	},
	{
		label: "Highest package",
		value: "₹22 LPA",
		note: "International data role",
	},
	{
		label: "Average package",
		value: "₹9.5 LPA",
		note: "Across recent 3 batches",
	},
];
...
const testimonials = [
	...
	},
	{
		...
		avatar: "https://images.pexels.com/photos/2232981/pexels-photo-2232981.jpeg",
		quote:
...
export default function Hero5() {
	return (
		<>
				...
				<div className={styles.inner}>
					...
					<div className={styles.left}>
						...
						<h2 className={styles.heading}>
							...
							<span className={styles.highlight}>data science</span> into real
							offers.
						</h2>
						<p className={styles.subtitle}>
							Structured learning, live projects, and dedicated placement support
							help you move from “interested in data” to “hired as a data
							professional”.
						</p>
			...
			{/* Full-width brand slider at the end */}
			<BrandSlider />
		</>
	);
}
