...
export default function Hero() {
  ...
  return (
    <section className={styles.hero} aria-label="Data Science Hero Section">
      ...
      <svg className={styles.visualizationSvg} viewBox="0 0 1200 800" preserveAspectRatio="none" aria-hidden="true">
        <defs>
      ...
      <div className={styles.content}>
        ...
        <nav className={styles.ctaButtons} aria-label="Primary actions">
          <Link href="/course" className={styles.buttonPrimary} aria-label="Explore Our Courses">
          ...
          <button className={styles.buttonSecondary} aria-label="Talk to a Career Expert">
